namespace Chess {
	...
	public class MoveGenerator {
		...
		void GenerateSlidingMoves () {
			// Generates sliding moves for rooks, bishops, and queens of the friendly color by invoking 
			//the GenerateSlidingPieceMoves function with appropriate arguments based on the piece and desired directions
