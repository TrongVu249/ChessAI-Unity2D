...
//  maintains a list of pieces on a chessboard. It uses two arrays, occupiedSquares and map, to store and manage the positions of the pieces. 
//The class provides methods to add, remove, and move pieces, as well as a property to retrieve the number of pieces in the list